  ...
  <?php
    ...
    <p align="center">
        ...
        if (isset($_SESSION['usuario'])) {
            ...
            echo '<a href="form-ing.php">NUEVO</a> | ';
			echo ' ';
...
<p>&nbsp;</p>
 ...
 echo "<td>
                        <a href='editar.php?id=" . urlencode($row['id']) . "'>Modificar</a> | 
                        <a href='eliminar.php?id=" . urlencode($row['id']) . "' onclick='return confirm(\"¿Estás seguro de que quieres eliminar este registro?\");'>Eliminar</a>
                      </td>";
