...
try {
    $stmt = $conexion->prepare("SELECT * FROM tabla_general WHERE id = :id");
    ...
    if ($registro) {
        ...
        <form action="actualizar.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="nombre" value="<?php echo htmlspecialchars($registro['nombre']); ?>" />
            </div>
            <div class="form-row">
            <label for="descripcion">descripcion:</label>
            <input type="text" name="descripcion" value="<?php echo htmlspecialchars($registro['descripcion']); ?>" />
            </div>
            <div class="form-row">
